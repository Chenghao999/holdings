...
- [ ] 券商对账单导入，模块化增加不同证券公司（[B-27](BACKLOG.md#b-27) 起 7 项）
      ——**口径与报告已交付**（[B-27](BACKLOG.md#b-27)：非买卖行不入账但逐行报出），
      解析器注册表（[B-28](BACKLOG.md#b-28)）与真实券商样本（[B-30](BACKLOG.md#b-30)）待做。
...
- [ ] v2.0.0 进行中：剩余 [B-21](BACKLOG.md#b-21)（多账户）、
      ...
      以及 [B-28](BACKLOG.md#b-28)~[B-33](BACKLOG.md#b-33)（券商对账单导入 / 标的资料）。
      [B-27](BACKLOG.md#b-27)（非买卖行的口径与报告）已交付。