...
- [ ] 券商对账单导入，模块化增加不同证券公司（[B-27](BACKLOG.md#b-27) 起 7 项）
      ...
      **解析器注册表**（[B-28](BACKLOG.md#b-28)：一家券商 = 一个模块 + 注册一行，
      含编码探测与「认不出就报错」）已交付；真实券商样本
      （[B-30](BACKLOG.md#b-30)）、导入幂等（[B-29](BACKLOG.md#b-29)）待做。
...
- [ ] v2.0.0 进行中：剩余 [B-21](BACKLOG.md#b-21)（多账户）、
      ...
      以及 [B-29](BACKLOG.md#b-29)~[B-33](BACKLOG.md#b-33)（券商对账单导入 / 标的资料）。
      [B-27](BACKLOG.md#b-27)（非买卖行的口径与报告）与
      [B-28](BACKLOG.md#b-28)（解析器注册表与自动识别）已交付。