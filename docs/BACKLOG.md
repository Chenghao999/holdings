...
**当前状态（2026-09-21）**：B-01~B-20 共 20 项**全部交付**
（用例 159 → 398，覆盖率 67% → 96%），**v1.0.0 已发布**。剩余 **B-21~B-23 共 3 项**，
...
3. ~~**B-20**~~ —— ✅ 已完成（2026-09-21），只读看板（[B-20](#b-20)）。
   **接着做 B-21 → B-23**。v2.0.0 的能力建设，按实际用到的顺序做；
   B-21（多账户）与 B-23（能力缺口）不依赖彼此，可以先做更常用的那个。
