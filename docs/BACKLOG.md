...
**当前状态（2026-09-20）**：B-01~B-19 共 19 项**全部交付**
（用例 159 → 380，覆盖率 67% → 95%），**v1.0.0 已发布**。剩余 **B-20~B-23 共 4 项**，
都是 v2.0.0 的能力建设，建议顺序见文末「[剩余条目的执行顺序](#剩余条目的执行顺序)」。
...
3. **B-20 → B-21 → B-23** —— **从这里接着做**。v2.0.0 的能力建设，按实际用到的顺序做。
